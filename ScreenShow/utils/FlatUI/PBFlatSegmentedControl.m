...
- (void)apperance {
    ...
    UIImage *normalBackgroundImage = [UIImage imageWithColor:[UIColor colorWithRed:0.527 green:0.160 blue:0.243 alpha:1.000] size:CGSizeMake(10.0f, 40.0f) andRoundSize:5.0f];
    UIImage *selectedBackgroundImage = [UIImage imageWithColor:[UIColor colorWithWhite:0.845 alpha:1.000] size:CGSizeMake(10.0f, 40.0f) andRoundSize:5.0f];
